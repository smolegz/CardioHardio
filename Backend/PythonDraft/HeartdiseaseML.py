...
from DataCollection import heartdata
...
mainX_train, mainX_test, mainY_train, mainY_test = \
    train_test_split(mainX, mainY, test_size=0.1, stratify=mainY, random_state=3)
...
hdPrediction = modelLR.predict(input_reshape)